...
TextEditingController accContr = TextEditingController();

class PayElectricity extends StatefulWidget {
  @override
  _PayElectricityState createState() => _PayElectricityState();
}

class _PayElectricityState extends State<PayElectricity> {
  ...
  showNotification() async {
    ...
    await flutterLocalNotificationsPlugin.show(0, 'MBECHE EFT',
        'Your Electricity transaction is complete, the units code : 1364 5465 6465 6452 ', platform,
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Image.asset('assets/Icon/electricity.png',
            ...
            Text(
                "Upon successful order, an sms notification will be sent to you",
                style: poppinsRegular.copyWith(
            ...
            Container(
              ...
              child: CustomButton(
                  ...
                  onTap: () async {
                    ...
                    } else if (accContr.text.length < 10){
                      showDialog(
                          context: context,
                          builder: (BuildContext context) =>
                              MessageDialog("Please provide valid Account Number, 10 numbers needed"));
                    }
                      else {
                      setState(() {
                        loadingPage = true;
